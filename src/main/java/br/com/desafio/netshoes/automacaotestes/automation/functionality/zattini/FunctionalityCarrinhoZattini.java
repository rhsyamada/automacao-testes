...
import br.com.desafio.netshoes.automacaotestes.automation.pageobjects.zattini.PageCarrinhoZattini;
...
@Functionality
public class FunctionalityCarrinhoZattini {
	@Autowired
	RepositoryTest repo;

	@Autowired
	PageCarrinhoZattini carrinho;
